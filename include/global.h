...
struct SaveBlock2
{
    ...
    /*0x14*/ u16 optionsTextSpeed:2; // OPTIONS_TEXT_SPEED_[INSTANT/MID/FAST]
...
struct SaveBlock1
{
    ...
    /*0x3598*/ u8 unused_3598[0x80];
               u8 routeEncounters[255]; // This is definately not all be needed but im too lazy to think about it properly
               u8 battleEncounterStatus; // im just being lazy now
